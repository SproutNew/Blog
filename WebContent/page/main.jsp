...
<body>
		...
		<div class="row c_center">
			<div class="col-md-3" id="left_content">
				...
				<div class="c_center" id="person_info">
					...
					<h4 class="text-muted">晚竹</h4>
					<h5 class="text-muted">一花一世界.</h5>
				</div>
	...
	<div id="footer">
		<div>
			<a href="https://github.com/SproutNew"><img src="/Blog/img/github.png"width="20px" height="20px" class="img-circle">&nbsp;&nbsp;GitHub</a>
			&nbsp;|
			<a href="#">&nbsp;&nbsp;MyBlog</a>
			<br/>
			copyright © 2018
